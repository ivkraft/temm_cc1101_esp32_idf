...
// Минимальный набор можно расширять; для меню обычно хватает ASCII 32..127.
// Здесь — полный базовый 8x8 (128 символов) обычно кладут целиком.
// Я даю компактный рабочий набор для печати (остальные = 0).
// Если захочешь полный — скажешь, я дам целиком одним блоком.

const uint8_t gfx_font8x8_basic[128][8] = {
